      ...
      <Container maxW="container.md" py={8}>
        <Flex flexDir={{ base: "column", md: "row" }} align="center">
          ...
          <Box p={4} textAlign={{ base: "left", md: "left" }}>
            ...
            <Text align="left">
              I am a Macedonian graduate student at Tokyo Institue of Technology
              majoring in the Department of Systems and Control Engineering,
              School of Engineering, Tokyo Institute of Technology, Japan. My
              academic advisor is Prof. Dr. Nakao Hiroya. I have a knack for
              problem solving. You can find my{" "}
        ...
        <Box p={4}>
          ...
          <Text mb={2}>
            ...
            Methods, Syncronization, Nonlinear System Analysis, Chaos Theory and
            ...
            fascination for intricate dynamics and their real-world
            applications.
          </Text>
          <Text mb={2}>
            ...
            engrossed in mastering Japanese. My linguistic journey has not only
            enabled me to bridge cultural gaps but has also kindled my curiosity
            for understanding diverse societies.
          </Text>

          <Text mb={2}>
            When I am not doing research or at the lab I tweak with my
            dot-files, program, tweak electronics or stroll through Akihabara to
            find dirt cheap electronics and garbage that I like tweaking with. I
        ...
        <Box p={4}>
          ...
          <List spacing={2} mb={4}>
            <ListItem>
              ...
              [2020] Undergraduate studies at Ss. Cyril and Methodius University
              of Skopje, Faculty of Electrical Engineering and Information
              Technology, Department of Systems and Control Engineering.
            </ListItem>
            <ListItem>
              <ListIcon as={SpinnerIcon} color="green.500" />
              [2021~] - Master studies at Department of Systems and Control
              Engineering, School of Engineering, Tokyo Institute of Technology,
              Japan.
            </ListItem>
          </List>
          ...
          <List spacing={2} mb={4}>
            ...
            <ListItem>
              <ListIcon as={CheckCircleIcon} color="green.500" />
              [2020] Worked as Front-End Senior Developer at Aritmatrix, Skopje.
            </ListItem>
